...
__device__ void matrixMul(double *C, double *A, double *B, size_type wA, size_type wB) {
  // Block index
...
extern "C" __global__ void matrixMul_bs16_64bit(double *C, double *A, double *B,
                                                size_t wA, size_t wB) {
  matrixMul<16, size_t>(C, A, B, wA, wB);
}
extern "C" __global__ void matrixMul_bs32_64bit(double *C, double *A, double *B,
                                                size_t wA, size_t wB) {
